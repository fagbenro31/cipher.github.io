...
titleTextStyle:{color: 'gold', fontName: 'Arial', fontSize: 15, bold:true, italic:false},
is3D: true,
legend:{textStyle:{color: 'gold', fontName: 'Arial', fontSize: 10, bold:true, italic:false}},
...
2: {offset: 0.2},
	...
	var chart = new google.visualization.PieChart(document.getElementById('piechart_3d36'));
	chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d27'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d26'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d28'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d29'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d30'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d31'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d32'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d33'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d34'));
chart.draw(data, options);
}
...
var chart = new google.visualization.PieChart(document.getElementById('piechart_3d35'));
chart.draw(data, options);
}
/* */
function drawChart5() {
